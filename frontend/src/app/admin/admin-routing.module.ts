...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'product-attribute-sets', component: ProductAttributeComponent, data: { animation: 'attribute' } },
      ...
      { path: 'product', component: ProductFormComponent, data: { animation: 'create' } },
